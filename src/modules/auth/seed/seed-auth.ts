...
export const DEFAULT_PERMISSIONS = [
  ...
  { key: 'rule:read', description: 'Read automation rule definitions' },
  { key: 'rule:create', description: 'Create automation rule definitions' },
  { key: 'rule:update', description: 'Update automation rule definitions' },
  { key: 'rule:delete', description: 'Delete automation rule definitions' },
  { key: 'webhook:read', description: 'Read outbound webhook endpoints and delivery logs' },
  { key: 'webhook:create', description: 'Create outbound webhook endpoints' },
  { key: 'webhook:update', description: 'Update outbound webhook endpoints' },
  { key: 'webhook:delete', description: 'Delete outbound webhook endpoints' },
  { key: 'job:read', description: 'Read scheduled job definitions and run history' },
  { key: 'job:trigger', description: 'Manually trigger scheduled jobs' },
  { key: 'workflow:read', description: 'Read workflow definitions and runs' },
  { key: 'workflow:manage', description: 'Create or update workflow definitions' },
